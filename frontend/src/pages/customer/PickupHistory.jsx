      ...
      <div className="mx-auto px-4 max-w-5xl  text-tc dark:text-ow">
        ...
        {pickups.length === 0 ? (
            ...
            <div className="space-y-4">
                {pickups.map((pickup) => 
                    <div key={pickup.id} className="bg-white dark:bg-dtc rounded-md p-3 sm:p-8 border border-neutral-200 dark:border-neutral-600">
                        <div className="flex items-center justify-between gap-2 mb-4">
                            <p className="font-semibold">PKP - {pickup.id}</p>
                            <span
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 items-center text-tc dark:text-ow">
                            <div className="flex flex-col justify-center">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{formatDate(pickup.requestedDate)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    {pickup.status === 'canceled' ?
                                        <div>
                                            ...
                                            <p className="font-medium">{formatDate(pickup.pickedDate)}</p>
                                        </div>:
                                        pickup.pickedDate ? (
                                            <div>
                                            ...
                                            <div>{getEstimatedPickup(pickup.requestedDate)}</div>
                                        )
                                    }
                                        ...
                                        {pickup.status === 'canceled' ?
                                            <p className="font-medium">Pickup Canceled</p>:
                                                pickup.green_coins_awarded !== 0 ? 
                                                    <p className="font-medium">{pickup.greenCoinsEarned}</p>:
                            ...
                            <div className="flex flex-col justify-center">
                                ...
                                <div className="space-y-1 pl-7">
                                    ...
                                    <p className="text-sm text-neutral-600 dark:text-neutral-300">{address.street}</p>
