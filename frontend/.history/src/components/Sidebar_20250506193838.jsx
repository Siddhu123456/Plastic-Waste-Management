import { 
  ...
  const Sidebar = ({ activePage, setActivePage, sidebarOpen, toggleSidebar }) => {
    return (
      <div className={`fixed lg:static inset-y-0 left-0 top-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-200 md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
