      ...
      <div className="mb-6">
        ...
        <div className="border-2 border-dashed border-gray-300 p-4 rounded text-center">
          ...
          <p className="text-sm text-gray-500">
            Select up to 4 images. First uploaded image will be set as primary by default.
          </p>
      ...
      {selectedFiles.length > 0 && (
        <div className="mb-6">
          ...
          <button
            ...
            disabled={uploading}
            className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition mt-4 w-full"
          >
