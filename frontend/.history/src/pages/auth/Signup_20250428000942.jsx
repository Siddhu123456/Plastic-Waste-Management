    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="flex flex-col gap-y-2">
          ...
          <p className="text-xs text-center text-red-600" id="password-error">
            ...
            <button type="submit" className="w-full py-2.5 px-4 text-lg font-medium pri-btn focus:outline-hidden focus:bg-lgd disabled:opacity-50 disabled:pointer-events-none">Sign up</button>
          </div>
        </form>
      </div>
