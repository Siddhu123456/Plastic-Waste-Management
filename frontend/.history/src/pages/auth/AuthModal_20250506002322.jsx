    ...
    >
        {
            isPasswordForgot ? <ForgotPassword setIsPasswordForgot={setIsPasswordForgot} /> :
                loginOpen ? <Login setLoginOpen={setLoginOpen} onClose={onClose} setIsPasswordForgot={() => setIsPasswordForgot(prev => !prev)} /> : 
                    <Signup setLoginOpen={setLoginOpen} setIsLogged={setIsLogged} onClose={onClose}/>
        }
    </Modal>
  )
}
