...
const ProductOverview = () => {
  const product = {
    ...
    description:
      "Experience premium sound quality with advanced Bluetooth 5.3 connectivity and a sleek, lightweight design.",
    price: 250,
    image: [
      "https://media.istockphoto.com/id/2204825940/photo/wireless-headphone.jpg?s=612x612&w=0&k=20&c=4XHfdkc95X-a3mB-M7ZAlJmMSH4_5LoIRUOzbvwWorI=",
      "https://media.istockphoto.com/id/1942137676/photo/woman-hand-holds-large-white-headphones-on-a-black-background-a-girl-holds-out-wireless.jpg?s=612x612&w=0&k=20&c=Z-IUnoLCUrBC7AeYnXypRVapRHmw9Y7xDK6SOLuQfaA=",
      "https://media.istockphoto.com/id/2194447978/photo/young-woman-enjoying-music-with-wireless-headphones-at-home.jpg?s=612x612&w=0&k=20&c=QYvzQ3gOfGtqEfgNZAoClyLHiVBW3tmZHPYhG8BQ2HY=",
    ],
    rating: 2.6,
    ratedCount: 134,
    stock: 10,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              {product.discount ?
                <span className="text-sm bg-red-100 text-red-600 dark:text-red-400 dark:bg-red-950 px-2 py-0.5 rounded-full">
