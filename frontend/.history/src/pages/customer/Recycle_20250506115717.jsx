  ...
  return (
    ...
    <div className="bg-white dark:bg-dtc rounded-md col-span-12 lg:col-span-6 p-4 sm:p-6">
      ...
      />
        ...
        <button type="button" onClick={()=>console.log(weight)} disabled={weight < minWeight} className="disabled:bg-neutral-500 disabled:cursor-not-allowed px-4 py-2.5 w-full font-semibold tracking-wide pri-btn">
          Submit Request
        </button>
      </div>
    </div>      
