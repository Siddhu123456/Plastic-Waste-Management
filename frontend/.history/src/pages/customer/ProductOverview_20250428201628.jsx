...
const ProductOverview = () => {
  ...
  const productData = {
    pName: "Plastic bag",
    description: "Experience premium sound quality with advanced Bluetooth 5.3 connectivity and a sleek, lightweight design.",
    price: 250,
    stock: 10,
    category: "Fashion",
    images: [
      {
        imageUrl: "https://media.istockphoto.com/id/2204825940/photo/wireless-headphone.jpg?s=612x612&w=0&k=20&c=4XHfdkc95X-a3mB-M7ZAlJmMSH4_5LoIRUOzbvwWorI=",
        primary: true
      },
      {
        imageUrl: "https://media.istockphoto.com/id/1942137676/photo/woman-hand-holds-large-white-headphones-on-a-black-background-a-girl-holds-out-wireless.jpg?s=612x612&w=0&k=20&c=Z-IUnoLCUrBC7AeYnXypRVapRHmw9Y7xDK6SOLuQfaA=",
        primary: false
      },
      {
        imageUrl: "https://media.istockphoto.com/id/2194447978/photo/young-woman-enjoying-music-with-wireless-headphones-at-home.jpg?s=612x612&w=0&k=20&c=QYvzQ3gOfGtqEfgNZAoClyLHiVBW3tmZHPYhG8BQ2HY=",
        primary: false
      }
    ],
    features: [
      { featureName: "Height", featureValue: "15cm" },
      { featureName: "Color", featureValue: "Black" },
      { featureName: "Bluetooth", featureValue: "5.3" },
      { featureName: "Battery", featureValue: "30hr" },
      { featureName: "Noise Cancelling", featureValue: "Yes" },
      { featureName: "Waterproof", featureValue: "IPX5" },
      { featureName: "Weight", featureValue: "210g" },
      { featureName: "Mic", featureValue: "Built-in" },
      { featureName: "Driver", featureValue: "40mm" }
    ]
  };
        ...
        <div className="bg-ow dark:bg-dsc p-0 sm:p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4 flex flex-col justify-between">
              ...
              <p className="text-gray-700 text-wrap dark:text-gray-300">{product.description}</p>
