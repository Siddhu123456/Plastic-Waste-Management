          ...
          <section className='grid grid-cols-12 gap-4 p-2 sm:p-4'>
            <div className="col-span-12 lg:col-span-7 bg-white dark:bg-dtc rounded-md p-4 sm:p-6">
              ...
              <div className="flex flex-col gap-8">
                <div className="space-y-0">
                  {cart.map(item => 
                    <CartItemCard key={item.id} item={item} removeItem={removeItem} modifyQty={modifyQty} />
                  )}
                </div>
              </div>
            </div>  
            ...
            <div className="bg-white dark:bg-dtc rounded-md col-span-12 lg:col-span-5 p-4 sm:p-6 h-max">
              ...
              <div className="mt-6 space-y-2">
                ...
                {subTotal > balance && <p className="text-right text-red-500">Insufficient Coins {balance}</p>}

                <button 
                type="button" disabled={subTotal < minOrderVal || balance < subTotal} 
