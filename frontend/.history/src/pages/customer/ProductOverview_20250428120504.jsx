...
const ProductOverview = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        // Replace with your backend URL for fetching the product by ID
    ...
    fetchProduct();
  }, [id]); // Dependency on 'id' ensures it fetches when the ID changes

  // Handle case when the product is not found or loading
